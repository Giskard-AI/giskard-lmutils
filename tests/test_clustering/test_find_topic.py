...
mock_response = ModelResponse(choices=[Choices(message={'role': 'assistant', 'content': 'some topic'})])
...
async def test_acomplete_custom_params():
    ...
    topic = await find_topic(litellm_model, [
        'This is a document',
        'This is a document',
        'This is a document',
        'This is a document',
